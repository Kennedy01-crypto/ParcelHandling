				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							...
							switch ($row['status']) {
								case '1':
									echo "<span class='badge badge-pill badge-info'> In-Transit(Shipping In Progress)</span>";
									break;
								case '2':
									echo "<span class='badge badge-pill badge-info'> Shipped(Arrived At Destination)</span>";
									break;
								case '3':
