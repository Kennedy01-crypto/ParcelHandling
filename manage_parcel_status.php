<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			<label for="">Update The Parcel Status</label>
			<?php $status_arr = array("Item Accepted by Courier","In-Transit(Shipping In Progress)","Shipped(Arrived At Destination)","Ready to Pickup","Picked-up","Out for Delivery","Delivered", "Collected", "Unsuccessfull Delivery Attempt"); ?>
