...
<?php if($_SESSION['login_type'] == 1): ?>
        <div class="row">
          ...
          <hr>
          <?php 
              $status_arr = array("Item Accepted by Courier","In-Transit(Shipping In Progress)","Shipped(Arrived At Destination)","Ready to Pickup","Picked-up","Out for Delivery","Delivered","Unsuccessfull Delivery Attempt", "Collected");
